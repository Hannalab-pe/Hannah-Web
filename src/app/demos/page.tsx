    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 z-10">
        <div className="relative z-20 max-w-7xl mx-auto">
          ...
          {/* Botón Ir al Inicio */}
          <div className={`flex justify-center mt-8 mb-6 transition-all duration-1500 ${
          ...
          <div className={`flex justify-center items-center mt-8 transition-all duration-1600 ${
            ...
            <div className="flex items-center gap-2 text-green-500/70">
              ...
              <p className="text-sm font-medium">
                Desarrollado por <span className="text-green-400 font-bold">HANNAH </span><span className="text-green-400 font-bold">LAB</span>
              </p>
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
            </div>
          </div>
